...
describe('Campaigns', () => {
  ...
  it('allows one to contribute and become an approver', async () => {
  ...
  it('requires an minimum amount of transaction', async () => {
    try {
      await campaign.methods.contribute().send({
        value: '5',
        from: accounts[1]
  ...
  it('processes requests', async () => {
    ...
    await campaign.methods.createRequest('buy',web3.utils.toWei('5','Ether'),accounts[1])
    .send({ from:accounts[0], gas: '1000000'});
